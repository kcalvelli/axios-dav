...
let
  ...
  # AI system prompt for mcp-dav tools
  mcpDavPrompt = ''
...
in
{
  ...
  config = lib.mkIf enabled {
    ...
    # AI system prompt for mcp-dav (used by Claude Code and Gemini CLI)
    xdg.configFile."ai/prompts/mcp-dav.md" = lib.mkIf mcpEnabled { text = mcpDavPrompt; };
